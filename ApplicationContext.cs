    ...
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Construct>().HasData(
                    ...
                    new Construct { Id = 3, Kind = 0, Name = "Вода", ValueExt = 0.9m, ValueInt = 1.2m, ValueMP = 1m },
                    new Construct { Id = 4, Kind = 0, Name = "Воздух", ValueExt = 0.8m, ValueInt = 0.8m, ValueMP = 0.5m },
                    new Construct { Id = 5, Kind = 0, Name = "Земля", ValueExt = 1m, ValueInt = 1.5m, ValueMP = 1.2m },

                    new Construct { Id = 6, Kind = 1, Name = "Касание", ValueExt = 1.2m, ValueInt = 1m, ValueMP = 0.8m },
                    new Construct { Id = 7, Kind = 1, Name = "Точка", ValueExt = 1m, ValueInt = 0.8m, ValueMP = 1.2m },
                    new Construct { Id = 8, Kind = 1, Name = "Снаряд", ValueExt = 1.4m, ValueInt = 1.2m, ValueMP = 1.4m },
                    new Construct { Id = 9, Kind = 1, Name = "Излучение", ValueExt = 1.2m, ValueInt = 0.5m, ValueMP = 1.2m },
                    new Construct { Id = 10, Kind = 1, Name = "Выпуск", ValueExt = 1.1m, ValueInt = 0.8m, ValueMP = 1.4m },
                    new Construct { Id = 11, Kind = 1, Name = "Насыщение", ValueExt = 1m, ValueInt = 2m, ValueMP = 0.2m },
                    new Construct { Id = 12, Kind = 1, Name = "Воплощение", ValueExt = 1m, ValueInt = 1m, ValueMP = 4m },
                    new Construct { Id = 13, Kind = 1, Name = "Луч", ValueExt = 1.2m, ValueInt = 1.2m, ValueMP = 1m },
                    new Construct { Id = 14, Kind = 1, Name = "Дождь", ValueExt = 0.8m, ValueInt = 1m, ValueMP = 2m },
                    new Construct { Id = 15, Kind = 1, Name = "Самопоток", ValueExt = 1m, ValueInt = 1.2m, ValueMP = 0.8m },
                    new Construct { Id = 16, Kind = 1, Name = "Покров", ValueExt = 0.8m, ValueInt = 1m, ValueMP = 1.2m },

                    new Construct { Id = 17, Kind = 2, Name = "Круг", ValueExt = 1m, ValueInt = 1.2m, ValueMP = 1.2m },
                    new Construct { Id = 18, Kind = 2, Name = "Овал", ValueExt = 1m, ValueInt = 1m, ValueMP = 1.3m },
                    new Construct { Id = 19, Kind = 2, Name = "Треугольник", ValueExt = 1m, ValueInt = 1m, ValueMP = 1.1m },
                    new Construct { Id = 20, Kind = 2, Name = "Полусфера", ValueExt = 1m, ValueInt = 1.25m, ValueMP = 1.1m },
                    new Construct { Id = 21, Kind = 2, Name = "Сфера", ValueExt = 1m, ValueInt = 1.5m, ValueMP = 1m },
                    new Construct { Id = 22, Kind = 2, Name = "Конус", ValueExt = 1m, ValueInt = 0.8m, ValueMP = 1.3m },
                    new Construct { Id = 23, Kind = 2, Name = "Куб", ValueExt = 1m, ValueInt = 1m, ValueMP = 1.4m },
                    ...
                    new Construct { Id = 30, Kind = 3, Name = "Ребро", ValueExt = 0m, ValueInt = 0.2m, ValueMP = 0.2m },
                    ...
                    new Construct { Id = 43, Kind = 3, Name = "Фантом", ValueExt = -0.5m, ValueInt = -0.5m, ValueMP = 2m },
                    new Construct { Id = 44, Kind = 3, Name = "Концентрация", ValueExt = 0m, ValueInt = 0.5m, ValueMP = 0.5m },
                    new Construct { Id = 45, Kind = 3, Name = "Клеть", ValueExt = 0m, ValueInt = 0.2m, ValueMP = 1.5m },
                    new Construct { Id = 46, Kind = 3, Name = "Путы", ValueExt = 0m, ValueInt = 0m, ValueMP = 1m },
                    new Construct { Id = 47, Kind = 3, Name = "Проницаемость", ValueExt = -0.7m, ValueInt = 0m, ValueMP = 4m },
                    new Construct { Id = 48, Kind = 3, Name = "Змей", ValueExt = -0.2m, ValueInt = 0m, ValueMP = 1m },
